...
- **Commands:**
  ...
  powershell -File tools\install-skill-mesh.ps1 -Provider claude -Home "$env:USERPROFILE"
  powershell -File tools\install-skill-mesh.ps1 -Provider gpt -Home "$env:USERPROFILE"
  powershell -File tools\install-skill-mesh.ps1 -Provider codex -Home "$env:USERPROFILE"
  powershell -File tools\inspect-host-install.ps1 -Home "$env:USERPROFILE"
  ```
  ```powershell
