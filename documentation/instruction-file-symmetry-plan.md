...
- **Depends on:** 107
- **Status:** LANDED / CERTIFICATION PENDING (2026-08-26) — build/install acceptance remains PASS. The repaired candidate is Git blob `bec161f56ec42f37b0e2d89cbcbc3b0a51e28f95`, raw SHA-256 `CF88FDB26FFE730A25A34EFA281D17F8F043678704E021DC8DC5C2258CFEA7D4` (137,620 bytes; 1,902 lines). Its pre-commit audit reports 0 high and 0 medium defects; all 24 PowerShell-bearing fences parse under Windows PowerShell 5.1, all 18 blockers exit nonzero when streamed, the credential corpus is 107/107 unique, and the package-integrity gate passes 278 tests. Two independent immutable-commit reviews and the stable repo-root gate remain pending; #152 stays open and Step 108 is not DONE. Every behavioral cell remains blank. See § 12 Round 10 and issues #152–#153.
...
profile. After acceptance, the three disposable roots are deleted rather than reverted through
Step 108P's reviewed safe-cleanup block; the export root is retained. Attended Step 109 host sessions also
...
- A fresh immutable-blob audit refuted the prior `5B3FC466…995F8` high-0/medium-0 claim. Proven
  ...
  blob, and moves all implementation/schema/post-code-gate obligations to #162. The frozen candidate
  is Git blob `bec161f56ec42f37b0e2d89cbcbc3b0a51e28f95`, whose raw blob bytes have SHA-256
  `CF88FDB26FFE730A25A34EFA281D17F8F043678704E021DC8DC5C2258CFEA7D4`, length 137,620 bytes and
  1,902 LF-terminated lines. A pre-commit audit reports 0 high and 0 medium defects; all 24
  PowerShell-bearing fences parse under Windows PowerShell 5.1, all 18 terminating blockers exit
  nonzero when streamed through `powershell -NoProfile -Command -`, the closed credential corpus is
  107/107 unique under ordinal-ignore-case comparison, and the package-integrity iteration gate
  passes 278 tests. Two independent reviews of the immutable commit and a stable repo-root gate are
  still required; neither is claimed by this addendum.
