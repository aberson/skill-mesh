...
- This wrapper maps no isolated fresh-context agent primitive: this core requires no isolated arm -- the independent wiki/doc checks run in this session, aggregating findings before fixing exactly as the core orders.
