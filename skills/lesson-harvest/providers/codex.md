...
- This wrapper maps no isolated fresh-context agent primitive: this core requires no isolated arm, so run the scan in this session, holding the same evidence bar -- every candidate is grounded in committed history, never in recollection.
