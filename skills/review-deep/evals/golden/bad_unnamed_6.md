<!-- BAD OUTPUT — DEFECT: bugs lens emits an invalid overall_verdict value ("BLOCKED") not in the per-lens enum -->
<!-- Violates SKILL.md lines 188-191, 548-559: per-lens overall_verdict enum is PASS / NEEDS-WORK / NO-EVIDENCE / FAILED / SKIPPED / NEEDS-CLARIFICATION — "BLOCKED" is not a valid value -->
...
- bugs: BLOCKED (1 findings, model: claude-sonnet-4-6)
