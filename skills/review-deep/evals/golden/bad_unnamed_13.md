<!-- BAD OUTPUT — DEFECT: anti-pattern: silent-wiring is emitted at Nit severity (catalog mandates Block) -->
<!-- Violates SKILL.md lines 317-408: each catalog entry has Severity: Block by definition; lower-severity defect shapes belong outside the catalog -->
