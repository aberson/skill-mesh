<!-- BAD OUTPUT — DEFECT: Block finding uses an invalid severity value ("Critical") not in the per-finding severity enum Block | Nit | FYI -->
<!-- Violates SKILL.md lines 109-111, 598-600: per-finding `severity` MUST be one of Block | Nit | FYI; "Critical" is not a valid value -->
