<!-- BAD OUTPUT — DEFECT: --plan-step provided in invocation but plan-conformance lens omitted from Lens verdicts (lens not spawned despite --plan-step) -->
<!-- Violates SKILL.md lines 28, 48-54: "--plan-step ... explicitly enables the plan-conformance lens" — when supplied, the lens MUST be spawned, not skipped -->
