<!-- GOLDEN OUTPUT — review-deep reference output that follows every rule -->
<!-- Canonical scenario: scenario_silent_wiring_toybox_step15. -->
<!-- Use this as the "must pass without false-positive flags" anchor. -->
