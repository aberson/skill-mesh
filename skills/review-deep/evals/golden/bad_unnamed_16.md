<!-- BAD OUTPUT — DEFECT: style lens runs at a non-default tier (sonnet) instead of the documented default (haiku) without --model-override in the invocation -->
<!-- Violates SKILL.md lines 462-470: default model-tier table assigns Style to Haiku 4.5; invocation does not include --model-override so Style MUST default to haiku -->
...
- style: PASS (0 findings, model: claude-sonnet-4-6)
