...
- Resolve capability tiers with the loaded package's `<loaded-package>/config/model-tier-map.md` (single fenced JSON payload; canonical source: `config/model-tier-map.json`); explicit router overrides win.
