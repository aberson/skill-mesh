...
- This wrapper maps no isolated fresh-context agent primitive: this core requires no isolated arm, so the whole validation runs in this session, with the same ordering and the same evidence requirement.
